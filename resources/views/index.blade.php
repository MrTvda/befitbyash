...
<body class="mb-5" style="background-color: #cfdcd3 !important">
  ...
  <main>
    <div class="container">
      <img class="pb-3 pt-4" src="/img/logo-min.png" alt="Foto van ashley" width="40%" style="margin: 0 auto; display: block">
      <div class="card">
        <div class="card-body text-white bg-dark border-0">
      ...
      <div class="card">
        <div class="card-body">
          <img class="w-50" src="/img/foto-ashley.jpg">
        </div>
      </div>
    </div>
  </main>
